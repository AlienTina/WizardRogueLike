...
namespace WizardRogueLike
{
    ...
    class SlowBall : Spell
    {
        public SlowBall(Vector2 _position, Vector2 _direction, float _speed, bool _isEnemy) : base(_position, _direction, _speed, _isEnemy)
        {
            this.position = _position;
            this.direction = _direction;
            this.speed = _speed;
        ...
        public override void Instantiate(Game1 game)
        {
            spellTexture = game.Content.Load<Texture2D>("sprites/Characters/slow_ball");
        }
    ...
    partial class Game1
    {
        List<Type> mySpells = new List<Type>(9);
        ...
        void SpellInstantiate ()
        {
            ...
            mySpells[0] = typeof(Fireball);
            mySpells[1] = typeof(ToxicBall);
            mySpells[2] = typeof(FireWorm);
            mySpells[3] = typeof(FireZone);
            mySpells[4] = typeof(ToxicZone);
            mySpells[5] = typeof(SlowBall);
